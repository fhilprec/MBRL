...
\cite{duan2016benchmarking,kaiser2019model}. Also, the lack of a model can make it difficult for the
...
agent more robust \cite{ha2018world,hafner2020dream}. Moreover they provide limited
...
environment \cite{janner2019trust,sutton1991dyna}. Moreover there are approaches that use
...
\cite{hafner2021mastering} is a model-based RL algorithm. In general, Dreamer
...
input to create objects from it \cite{greff2020object} but
also approaches where the objects states are extracted from RAM
\cite{delfosse2023ocatari} or given directly by the
...
\cite{delfosse2023ocatari}. OCAtari extends the
...
\cite{delfosse2023ocatari}. This misalignment
...
Building upon OCAtari, JAXAtari \cite{machado2023revisiting} provides a JAX-based
